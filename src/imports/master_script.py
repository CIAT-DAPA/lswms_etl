...
if __name__ == "__main__":
    ...
    selected_files_to_execute = ["import_adm1.py", "import_adm2.py","import_adm3.py","import_watershed.py","import_waterpoint.py","import_climatology.py","import_type_content.py","import_wp_content.py","import_watershed_content.py","import_monitored.py",]
